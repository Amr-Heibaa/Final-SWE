<x-app-layout title="ManufacTrack">
            ...
            <div class="container">
                <div class="nav-row">
                    ...
                    <nav class="nav-links" aria-label="Primary">
                        ...
                        <a class="nav-link" href="{{ route('about') }}#about">Our Story</a>
                        <a class="nav-link" href="{{ route('operations') }}#operations">Operations</a>
                        <a class="nav-link" href="{{ route('media') }}#clients">Clients</a>
                ...
                <div class="mobile-panel" id="mobilePanel">
                    <div class="mobile-links">
                        ...
                        <a class="mobile-link" href="{{ route('meetings.create') }}">Contact</a>
                    </div>
            ...
            <div class="container">
                ...
                <div class="clients-grid">
                    @for ($i = 1; $i <= 12; $i++)
                        ...
                        <img src="{{ asset('images/' . $i . '.jpg') }}" alt="Client logo" class="client-logo-img">
                </div>
                @endfor
            </div>
    </div>
    ...
    <script>
        ...
        const sections = ["home", "about", "operations", "clients"]
